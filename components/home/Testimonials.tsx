        ...
        >
          ...
          <div className="flex items-center justify-center gap-4 mt-10">
            <button
              ...
              className="w-9 h-9 border border-platinum-dark rounded-full flex items-center justify-center text-obsidian/50 hover:text-gold hover:border-gold transition-all"
            >
